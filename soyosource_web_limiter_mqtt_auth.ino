...
void setup()  {
  ...
  ESPAsync_WMParameter custom_mqtt_user("user", "mqtt_user", mqtt_user, 40);
  ESPAsync_WMParameter custom_mqtt_password("password", "mqtt_password", mqtt_password, 40);
  ...
  if(!res) {
    ...
    DEBUG_SERIAL.println(String("mqtt_user: ") + mqtt_user);
    DEBUG_SERIAL.println(String("mqtt_password: ") + mqtt_password);
